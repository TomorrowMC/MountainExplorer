...
struct MountainData {
   static var favorMountains: [Mountain] = []
        var mountains: [Mountain] = [
            ...
            Mountain(id:3, name: "MOUNT EMEI", length: 20, altitude: 3099, time: "16h", tags: ["Hard", "Sacred"], likedCount: "8.3k", province: "SICHUAN", location: CLLocationCoordinate2D(latitude: 0.001, longitude: 0), rate: Int.random(in: 3...5), peopleflow: Int.random(in: 3...5), energyConsumption: Int.random(in: 3...5), climbingTools: ["Rope"], introduction: "Mount Emei, located in the southwest of Sichuan Province, is one of the Four Sacred Buddhist Mountains in China."),
            Mountain(id:4, name: "MOUNT HUA", length: 12, altitude: 2154, time: "8h", tags: ["Hard", "Steep"], likedCount: "10.7k", province: "SHAAN XI", location: CLLocationCoordinate2D(latitude: 0.001, longitude: 0), rate: Int.random(in: 3...5), peopleflow: Int.random(in: 3...5), energyConsumption: Int.random(in: 3...5), climbingTools: ["Climbing Pole", "Tent",  "Rope"], introduction: "Mount Hua, located in Huayin City, Shaanxi Province, is one of the Five Great Mountains in China. It is known for its steep terrain and unique natural scenery."),
            Mountain(id:6,name: "MOUNT CHANGBAI", length: 13, altitude: 2691, time: "7h 30min", tags: ["Hard", "Volcanic"], likedCount: "6.2k", province: "JILIN",location: CLLocationCoordinate2D(latitude: 42.039278, longitude: 128.085556), rate: Int.random(in: 3...5), peopleflow: Int.random(in: 3...5), energyConsumption: Int.random(in: 3...5), climbingTools: ["Climbing Pole", "Raincoat", "Rope"], introduction: "Changbai Mountain is located on the border between China and North Korea. It is a famous mountain range in northeastern China, with Changbai Mountain as the main peak, which is 2691 meters above sea level. The scenic area is a comprehensive nature reserve integrating forest, volcanic and wetland ecosystems.")
    ]
